...
// build questions that will be picked randomly in each iteration of the program where the user will be prompted to answer between three choices.
// evaluate the answer and display if it's correct or incorrect.
